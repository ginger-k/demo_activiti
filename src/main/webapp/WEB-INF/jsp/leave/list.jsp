 	...
 	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
		        <td height="20" bgcolor="#FFFFFF" class="STYLE10" colspan="8"><div align="left">
					<a href="${pageContext.request.contextPath }/leave/toInput.do">添加请假申请</a>
				</div></td>
		  </tr> 
		  <tr>
		    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
		      ...
		      <c:forEach var="leave" items="${leaveList}">
		      		<tr>
				        ...
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${globle_user.name }</div></td>
				        ...
				        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
				        	<c:if test="${leave.state==0}">
			        			<a href="${pageContext.request.contextPath }/leave/toInput.do?leaveId=${leave.id}" >修改</a>
								<a href="${pageContext.request.contextPath }/leave/delete.do?leaveId=${leave.id}" >删除</a>
								<a href="${pageContext.request.contextPath }/workflow/startProcess.do?leaveId=${leave.id}" >申请请假</a>
			        		</c:if>
			 				<c:if test="${leave.state==1}">
			 					<a href="${pageContext.request.contextPath }/workflow/viewRecord.do?leaveId=${leave.id}" >查看审核记录</a>
			 				</c:if>
			 				<c:if test="${leave.state==2}">
			 					<a href="${pageContext.request.contextPath }/leave/delete.do?leaveId=${leave.id}" >删除</a>
			 					<a href="${pageContext.request.contextPath }/workflow/viewRecord.do?leaveId=${leave.id}" >查看审核记录</a>
