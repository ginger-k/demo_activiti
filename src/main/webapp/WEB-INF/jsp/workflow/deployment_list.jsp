...
<body>
		      		...
		      		<tr>
				        ...
				        <td height="20" bgcolor="#FFFFFF">
				        	<div align="center" class="STYLE21">
				        		<a href="deleteDeployment.do?deploymentId=${dep.id}">删除</a>
				        	</div>
				        </td>
				    </tr> 
		      </c:forEach>
		        ...
		        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">操作</span></div></td>
		      	...
		      	<c:forEach var="pd" items="${pdList}">
		      		<tr>
				        ...
				        <td height="20" bgcolor="#FFFFFF">
				        	<div align="center" class="STYLE21">
				        		<a target="_blank" href="viewImage.do?deploymentId=${pd.deploymentId}&imageName=${pd.diagramResourceName}">查看流程图</a> 
					 		</div>
					 	</td>
				    </tr> 
				</c:forEach>
	...
	<br/>
	<!-- 发布流程 -->
	<form action="addDeployment.do" enctype="multipart/form-data" method="POST">
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
		    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		      <tr>
		  ...
		  <tr>
		    <td>
		    	<div align="left" class="STYLE21">
					流程名称：<input type="text" name="deployName" cssStyle="width: 200px;"/><br/>
